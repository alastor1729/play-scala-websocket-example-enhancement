...
// JSON presentation class for StockDelete
case class StockDelete(symbol: StockSymbol)

object StockDelete {
  import play.api.libs.json._

  implicit val stockDeleteWrites: Writes[StockDelete] = new Writes[StockDelete] {
    override def writes(delete: StockDelete): JsValue = Json.obj(
      "type" -> "stockdelete",
